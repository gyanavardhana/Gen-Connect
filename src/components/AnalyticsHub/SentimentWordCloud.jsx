    ...
    <div style={{ textAlign: 'center' }}>
      ...
      {selectedWord && (
        <div style={{ marginTop: '20px', backgroundColor: '#f0f0f0', padding: '10px', borderRadius: '5px' }}>
          <h3 style={{ margin: '0 0 10px 0' }}>Selected Word: {selectedWord.text}</h3>
          <p style={{ margin: '5px 0' }}>Size: {selectedWord.size}</p>
          <p style={{ margin: '5px 0' }}>Sentiment: {selectedWord.sentiment !== undefined ? selectedWord.sentiment.toFixed(2) : 'N/A'}</p>
        </div>
      )}
    </div>
  );
